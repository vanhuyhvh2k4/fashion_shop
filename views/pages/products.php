...
require_once '../../controllers/ProductController.php'; // Controller class

// Initialize database connection (example)
$productController = new ProductController($productModel);

// Get keyword from URL query string
$keyword = isset($_GET['search']) ? $_GET['search'] : '';

// Search for products if keyword exists
                ...
                <div class="row pb-3">
                    ...
                    ?>
                            <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                                <div class="card product-item border-0 mb-4">
                                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                        <img class="img-fluid w-100" src="../../upload/products/<?= htmlspecialchars($product['image']) ?>" alt="">
                                    </div>
                                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                        <h6 class="text-truncate mb-3"><?= htmlspecialchars($product['name']) ?></h6>
                                        <div class="d-flex justify-content-center">
                                            <h6>$<?= number_format($product['stock'], 0) ?></h6>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex justify-content-between bg-light border">
                                        ...
                                        <a href="cart.php?action=add&id=<?= $product['id'] ?>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                                    </div>
                                </div>
                            </div>
                        <?php
                        ...
                        <div class="col-12 text-center">
                            <p class="text-muted"><?= $products['notfound'] ?></p>
                        </div>
                    <?php
                    }
                    ?>
